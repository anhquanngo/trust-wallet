      ...
      <View style={{backgroundColor: '#fff'}}>
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 22}}>Wallets</Text>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Dark Mode</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Setting-InviteFriend')}>
          <View
            style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 22}}>Invite a Friend</Text>
                <Text style={{fontSize: 18, color: '#989898'}}>
                  Get TWT Tokens
                </Text>
              </View>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Setting-Security')}>
          <View
            style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 22}}>Security</Text>
              </View>
            </View>
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22, margin: 10}}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Setting-Notifications')}>
          <View
            style={{
              flexDirection: 'row',
              justifyContent: 'space-between',
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Help Center</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Twitter</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Telegram</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Facebook</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Reddit</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{justifyContent: 'center'}}>
              <Text style={{fontSize: 22}}>Make a suggestion</Text>
            </View>
          </View>
          <View style={{justifyContent: 'center'}}>
            <Text style={{fontSize: 22, margin: 10}}>
